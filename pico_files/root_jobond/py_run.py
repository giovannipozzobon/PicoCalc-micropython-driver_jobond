...
def connect_wifi():
    ...
    time.sleep_ms(900)
    print("\n===Wifi Conneting ===")
    sta_if.connect("Eero Wifi","f7@NgMX6o*n_")
    time.sleep_ms(900)
...
def print_date_time():
    ...
    print(f"Ora: {hour:02d}:{minute:02d}:{second:02d}")

def set_date_time():
    # Richiesta input all'utente
    print("**** Inserisci data e ora ****")
    try:
        year = int(input("Inserisci l'anno (es. 2025): "))
        month = int(input("Inserisci il mese (1-12): "))
        day = int(input("Inserisci il giorno (1-31): "))
        hour = int(input("Inserisci l'ora (0-23): "))
        minute = int(input("Inserisci i minuti (0-59): "))
        second = int(input("Inserisci i secondi (0-59): "))

        rtc.set_time(year, month, day, hour, minute, second)
        print("RTC aggiornato con successo!")
        print_date_time()

    except Exception as e:
        print("Errore nell'inserimento dei dati:", e)

def set_datetime_with_ntp():
        rtc.set_datetime_ntp()
...
def main_menu():
    ...
    while True:
        ...
        print("W: Connect Wifi")
        print("P: Start WebRepl")
        print("D: Stampa Date Time")
        print("I: Imposta Date Time manualmente")
        print("N: Imposta Date Time con server NTP")
